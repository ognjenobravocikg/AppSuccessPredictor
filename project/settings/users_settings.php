...
<body>
    ...
    <div class="navbar">
        <div class="linkings">
            ...
            <a href="../user_index.php">Vrati se na početnu stranu</a>
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            <div class="input-group">
                ...
                <input type="text" name="new_name" value="<?php echo $users_data['name']; ?>">
            </div>
            <div class="input-group">
                <label for="new_email">Novi email:</label>
                <input type="email" name="new_email" value="<?php echo $users_data['email']; ?>">
            </div>
            <div class="input-group">
            ...
            <div class="input-group">
                <label for="new_interest">Interesuje te:</label>
                <input type="text" name="new_interest" id="new_interest" value="<?php echo $users_data['interests']; ?>">
            </div>
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                if ($current_password === $users_data['password']) {
                    // Update user information in the database
                    $query = "UPDATE users SET name = '$new_name', interests = '$new_interest', email = '$new_email'";
                    ...
                    $query .= " WHERE user_id = {$users_data['user_id']}";
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Initialize autocomplete on the category input fields
            $("#new_interest, #new_skill").autocomplete({
